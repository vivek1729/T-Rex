...
function showClass(a) {
    var b = document.querySelectorAll("." + a),
        c = 0,
        d = b.length;
    for (c; c < d; c++) b[c].style.display = "", b[c].style.visibility = "visible"
}! function() {
    "use strict";
    ...
    function j(b, c, d, e) {
        ...
        return f.className = e ? a.classes.CANVAS + " " + e : a.classes.CANVAS, f.width = c, f.height = d, b.appendChild(f), f
    }

    function k(a) {
        for (var b = a.length / 4 * 3, c = atob(a), d = new ArrayBuffer(b), e = new Uint8Array(d), f = 0; f < b; f++) e[f] = c.charCodeAt(f);
        return e.buffer
    }
    ...
    function m(a, b, c, d) {
        this.canvas = a, this.canvasCtx = a.getContext("2d"), this.canvasDimensions = d, this.textImgPos = b, this.restartImgPos = c, this.draw()
    }
    ...
    function n(b, c, d) {
        ...
        if (d && p(d, f, g), q(f, g))
            for (var h = b.collisionBoxes, i = c.ducking ? t.collisionBoxes.DUCKING : t.collisionBoxes.RUNNING, j = 0; j < i.length; j++)
    ...
    function p(a, b, c) {
        a.save(), a.strokeStyle = "#f00", a.strokeRect(b.x, b.y, b.width, b.height), a.strokeStyle = "#0f0", a.strokeRect(c.x, c.y, c.width, c.height), a.restore()
    }
    ...
    function q(a, b) {
        var c = !1,
            f = (a.x, a.y, b.x);
        b.y;
        return a.x < f + b.width && a.x + a.width > f && a.y < b.y + b.height && a.height + a.y > b.y && (c = !0), c
    }
    ...
    function s(a, b, c, d, e, f, g) {
        this.canvasCtx = a, this.spritePos = c, this.typeConfig = b, this.gapCoefficient = e, this.size = h(1, s.MAX_OBSTACLE_LENGTH), this.dimensions = d, this.remove = !1, this.xPos = d.WIDTH + (g || 0), this.yPos = 0, this.width = 0, this.collisionBoxes = [], this.gap = 0, this.speedOffset = 0, this.currentFrame = 0, this.timer = 0, this.init(f)
    }

    function t(a, b) {
        this.canvas = a, this.canvasCtx = a.getContext("2d"), this.spritePos = b, this.xPos = 0, this.yPos = 0, this.groundYPos = 0, this.currentFrame = 0, this.currentAnimFrames = [], this.blinkDelay = 0, this.animStartTime = 0, this.timer = 0, this.msPerFrame = 1e3 / c, this.config = t.config, this.status = t.status.WAITING, this.jumping = !1, this.ducking = !1, this.jumpVelocity = 0, this.reachedMinHeight = !1, this.speedDrop = !1, this.jumpCount = 0, this.jumpspotX = 0, this.init()
    }

    function u(b, c, d) {
        this.canvas = b, this.canvasCtx = b.getContext("2d"), this.image = a.imageSprite, this.spritePos = c, this.x = 0, this.y = 5, this.currentDistance = 0, this.maxScore = 0, this.highScore = 0, this.container = null, this.digits = [], this.acheivement = !1, this.defaultString = "", this.flashTimer = 0, this.flashIterations = 0, this.invertTrigger = !1, this.config = u.config, this.maxScoreUnits = this.config.MAX_DISTANCE_UNITS, this.init(d)
    }

    function v(a, b, c) {
        this.canvas = a, this.canvasCtx = this.canvas.getContext("2d"), this.spritePos = b, this.containerWidth = c, this.xPos = c, this.yPos = 0, this.remove = !1, this.cloudGap = h(v.config.MIN_CLOUD_GAP, v.config.MAX_CLOUD_GAP), this.init()
    }

    function w(a, b, c) {
        this.spritePos = b, this.canvas = a, this.canvasCtx = a.getContext("2d"), this.xPos = c - 50, this.yPos = 30, this.currentPhase = 0, this.opacity = 0, this.containerWidth = c, this.stars = [], this.drawStars = !1, this.placeStars()
    }

    function x(a, b) {
        this.spritePos = b, this.canvas = a, this.canvasCtx = a.getContext("2d"), this.sourceDimensions = {}, this.dimensions = x.dimensions, this.sourceXPos = [this.spritePos.x, this.spritePos.x + this.dimensions.WIDTH], this.xPos = [], this.yPos = 0, this.bumpThreshold = .5, this.setSourceDimensions(), this.draw()
    }

    function y(a, b, c, d) {
        this.canvas = a, this.canvasCtx = this.canvas.getContext("2d"), this.config = y.config, this.dimensions = c, this.gapCoefficient = d, this.obstacles = [], this.obstacleHistory = [], this.horizonOffsets = [0, 0], this.cloudFrequency = this.config.CLOUD_FREQUENCY, this.spritePos = b, this.nightMode = null, this.clouds = [], this.cloudSpeed = this.config.BG_CLOUD_SPEED, this.horizonLine = null, this.init()
    }
    window.Runner = a;
    var b = 600,
        c = 60,
    ...
    a.config = {
        ...
        loadImages: function() {
            d ? (a.imageSprite = document.getElementById("offline-resources-2x"), this.spriteDef = a.spriteDefinition.HDPI) : (a.imageSprite = document.getElementById("offline-resources-1x"), this.spriteDef = a.spriteDefinition.LDPI), this.init()
        },
        loadSounds: function() {
            if (!e) {
                ...
                for (var c in a.sounds) {
                    ...
                    var f = k(d);
                    this.audioContext.decodeAudioData(f, function(a, b) {
                        this.soundFx[a] = b
                    }.bind(this, c))
                }
            }
        ...
        init: function() {
            this.adjustDimensions(), this.setSpeed(), this.containerEl = document.createElement("div"), this.containerEl.className = a.classes.CONTAINER, this.canvas = j(this.containerEl, this.dimensions.WIDTH, this.dimensions.HEIGHT, a.classes.PLAYER), this.canvas.id = "gamecanvas", this.canvasCtx = this.canvas.getContext("2d"), this.canvasCtx.fillStyle = "#f7f7f7", this.canvasCtx.fill(), a.updateCanvasScaling(this.canvas), this.horizon = new y(this.canvas, this.spriteDef, this.dimensions, this.config.GAP_COEFFICIENT), this.distanceMeter = new u(this.canvas, this.spriteDef.TEXT_SPRITE, this.dimensions.WIDTH), this.tRex = new t(this.canvas, this.spriteDef.TREX), this.outerContainerEl.appendChild(this.containerEl), f && this.createTouchController(), this.startListening(), this.update(), window.addEventListener(a.events.RESIZE, this.debounceResize.bind(this))
        },
        createTouchController: function() {
            this.touchController = document.createElement("div"), this.touchController.className = a.classes.TOUCH_CONTROLLER
        },
        ...
        playIntro: function() {
            if (this.started || this.crashed) this.crashed && this.restart();
                ...
                document.styleSheets[0].insertRule(b, 0), this.containerEl.addEventListener(a.events.ANIM_END, this.startGame.bind(this)), this.containerEl.style.webkitAnimation = "intro .4s ease-out 1 both", this.containerEl.style.width = this.dimensions.WIDTH + "px", this.touchController && this.outerContainerEl.appendChild(this.touchController), this.activated = !0, this.started = !0
            }
        },
        startGame: function() {
            hideClass("hidewhenplaying"), this.runningTime = 0, this.playingIntro = !1, this.tRex.playingIntro = !1, this.containerEl.style.webkitAnimation = "", this.playCount++, document.addEventListener(a.events.VISIBILITY, this.onVisibilityChange.bind(this)), window.addEventListener(a.events.BLUR, this.onVisibilityChange.bind(this)), window.addEventListener(a.events.FOCUS, this.onVisibilityChange.bind(this))
        },
        ...
        update: function() {
            ...
            if (this.time = a, this.activated) {
                this.clearCanvas(), this.tRex.jumping && this.tRex.updateJump(b), this.runningTime += b;
                var c = this.runningTime > this.config.CLEAR_TIME;
                1 != this.tRex.jumpCount || this.playingIntro || this.playIntro(), this.playingIntro ? this.horizon.update(0, this.currentSpeed, c) : (b = this.started ? b : 0, this.horizon.update(b, this.currentSpeed, c, this.inverted));
        ...
        onKeyUp: function(b) {
            ...
            else if (a.keycodes.DUCK[c]) this.tRex.speedDrop = !1, this.tRex.setDuck(!1);
            else if (this.crashed) {
                var e = l() - this.time;
                (a.keycodes.RESTART[c] || this.isLeftClickOnCanvas(b) || e >= this.config.GAMEOVER_CLEAR_TIME && a.keycodes.JUMP[c]) && this.restart()
        ...
        gameOver: function() {
            showClass("hidewhenplaying"), gamecount++, this.playSound(this.soundFx.HIT), i(200), this.stop(), this.crashed = !0, this.distanceMeter.acheivement = !1, this.tRex.update(100, t.status.CRASHED), this.gameOverPanel ? this.gameOverPanel.draw() : this.gameOverPanel = new m(this.canvas, this.spriteDef.TEXT_SPRITE, this.spriteDef.RESTART, this.dimensions), this.distanceRan > this.highestScore && (this.highestScore = Math.ceil(this.distanceRan), this.distanceMeter.setHighScore(this.highestScore)), cscr = this.distanceMeter.getActualDistance(Math.ceil(this.distanceRan)), this.time = l(), this.checkWR(cscr)
        },
        checkWR: function(a) {
            $.get("/game.cgi?act=gethighscore&sessid=" + sessid, function(b, c) {
                a > b && $.ajax({
                    type: "POST",
                    url: "/game.cgi",
                    data: {
        ...
        restart: function() {
            hideClass("hidewhenplaying"), this.raqId || (this.playCount++, this.runningTime = 0, this.activated = !0, this.crashed = !1, this.distanceRan = 0, this.setSpeed(this.config.SPEED), this.time = l(), this.containerEl.classList.remove(a.classes.CRASHED), this.clearCanvas(), this.distanceMeter.reset(this.highestScore), this.horizon.reset(), this.tRex.reset(), this.playSound(this.soundFx.BUTTON_PRESS), this.invert(!0), this.update())
        },
        ...
        playSound: function(a) {
            if (a) {
                ...
                b.buffer = a, b.connect(this.audioContext.destination), b.start(0)
            }
        },
        invert: function(b) {
        ...
        if (e !== f) {
            var h = b || a.width,
                i = c || a.height;
            return a.width = h * g, a.height = i * g, a.style.width = h + "px", a.style.height = i + "px", d.scale(g, g), !0
        }
        ...
        updateDimensions: function(a, b) {
            this.canvasDimensions.WIDTH = a, b && (this.canvasDimensions.HEIGHT = b)
        },
        draw: function() {
            var b = m.dimensions,
            ...
            d && (f *= 2, e *= 2, g *= 2, h *= 2, n *= 2, o *= 2), e += this.textImgPos.x, f += this.textImgPos.y, this.canvasCtx.drawImage(a.imageSprite, e, f, g, h, i, j, k, l), this.canvasCtx.drawImage(a.imageSprite, this.restartImgPos.x, this.restartImgPos.y, n, o, p, q, b.RESTART_WIDTH, b.RESTART_HEIGHT)
        }
    }, s.MAX_GAP_COEFFICIENT = 1.5, s.MAX_OBSTACLE_LENGTH = 3, s.prototype = {
        init: function(a) {
        ...
        draw: function() {
            ...
            this.currentFrame > 0 && (e += b * this.currentFrame), this.canvasCtx.drawImage(a.imageSprite, e, this.spritePos.y, b * this.size, c, this.xPos, this.yPos, this.typeConfig.width * this.size, this.typeConfig.height)
        },
        update: function(a, b) {
        ...
        cloneCollisionBoxes: function() {
            for (var a = this.typeConfig.collisionBoxes, b = a.length - 1; b >= 0; b--) this.collisionBoxes[b] = new r(a[b].x, a[b].y, a[b].width, a[b].height)
        }
    }, s.types = [{
        type: "CACTUS_SMALL",
        width: 17,
        ...
        init: function() {
            this.blinkDelay = this.setBlinkDelay(), this.groundYPos = a.defaultDimensions.HEIGHT - this.config.HEIGHT - a.config.BOTTOM_PAD, this.yPos = this.groundYPos, this.minJumpHeight = this.groundYPos - this.config.MIN_JUMP_HEIGHT, this.draw(0, 0), this.update(0, t.status.WAITING)
        },
        setJumpVelocity: function(a) {
            this.config.INIITAL_JUMP_VELOCITY = -a, this.config.DROP_VELOCITY = -a / 2
        },
        update: function(a, b) {
            this.timer += a, b && (this.status = b, this.currentFrame = 0, this.msPerFrame = t.animFrames[b].msPerFrame, this.currentAnimFrames = t.animFrames[b].frames, b == t.status.WAITING && (this.animStartTime = l(), this.setBlinkDelay())), this.playingIntro && this.xPos < this.config.START_X_POS && (this.xPos += Math.round(this.config.START_X_POS / this.config.INTRO_DURATION * a)), this.status == t.status.WAITING ? this.blink(l()) : this.draw(this.currentAnimFrames[this.currentFrame], 0), this.timer >= this.msPerFrame && (this.currentFrame = this.currentFrame == this.currentAnimFrames.length - 1 ? 0 : this.currentFrame + 1, this.timer = 0), this.speedDrop && this.yPos == this.groundYPos && (this.speedDrop = !1, this.setDuck(!0))
        },
        draw: function(b, c) {
            var e = b,
                f = c,
            ...
            d && (e *= 2, f *= 2, g *= 2, h *= 2), e += this.spritePos.x, f += this.spritePos.y, this.ducking && this.status != t.status.CRASHED ? this.canvasCtx.drawImage(a.imageSprite, e, f, g, h, this.xPos, this.yPos, this.config.WIDTH_DUCK, this.config.HEIGHT) : (this.ducking && this.status == t.status.CRASHED && this.xPos++, this.canvasCtx.drawImage(a.imageSprite, e, f, g, h, this.xPos, this.yPos, this.config.WIDTH, this.config.HEIGHT))
        },
        ...
        updateJump: function(a, b) {
            var c = t.animFrames[this.status].msPerFrame,
                d = a / c;
            this.speedDrop ? this.yPos += Math.round(this.jumpVelocity * this.config.SPEED_DROP_COEFFICIENT * d) : this.yPos += Math.round(this.jumpVelocity * d), this.jumpVelocity += this.config.GRAVITY * d, (this.yPos < this.minJumpHeight || this.speedDrop) && (this.reachedMinHeight = !0), (this.yPos < this.config.MAX_JUMP_HEIGHT || this.speedDrop) && this.endJump(), this.yPos > this.groundYPos && (this.reset(), this.jumpCount++), this.update(a)
        },
        ...
        init: function(a) {
            ...
            for (var c = 0; c < this.maxScoreUnits; c++) this.draw(c, 0), this.defaultString += "0", b += "9";
        ...
        draw: function(a, b, c) {
            ...
            this.canvasCtx.drawImage(this.image, g, h, e, f, i, j, k, l), this.canvasCtx.restore()
        },
        ...
        update: function(a, b) {
            ...
            if (c)
                for (var f = this.digits.length - 1; f >= 0; f--) this.draw(f, parseInt(this.digits[f]));
            return this.drawHighScore(), d
        },
        ...
        init: function() {
            this.yPos = h(v.config.MAX_SKY_LEVEL, v.config.MIN_SKY_LEVEL), this.draw()
        },
        draw: function() {
            this.canvasCtx.save();
            var b = v.config.WIDTH,
                c = v.config.HEIGHT;
            d && (b = 2 * b, c = 2 * c), this.canvasCtx.drawImage(a.imageSprite, this.spritePos.x, this.spritePos.y, b, c, this.xPos, this.yPos, v.config.WIDTH, v.config.HEIGHT), this.canvasCtx.restore()
        },
        update: function(a) {
        ...
        STAR_MAX_Y: 70,
        WIDTH: 20
    }, w.phases = [140, 120, 100, 60, 40, 20, 0], w.prototype = {
        update: function(a, b) {
            if (a && 0 == this.opacity && (this.currentPhase++, this.currentPhase >= w.phases.length && (this.currentPhase = 0)), a && (this.opacity < 1 || 0 == this.opacity) ? this.opacity += w.config.FADE_SPEED : this.opacity > 0 && (this.opacity -= w.config.FADE_SPEED), this.opacity > 0) {
                if (this.xPos = this.updateXPos(this.xPos, w.config.MOON_SPEED), this.drawStars)
                    for (var c = 0; c < w.config.NUM_STARS; c++) this.stars[c].x = this.updateXPos(this.stars[c].x, w.config.STAR_SPEED);
                this.draw()
            } else this.opacity = 0, this.placeStars();
            this.drawStars = !0
        },
        updateXPos: function(a, b) {
            return a < -w.config.WIDTH ? a = this.containerWidth : a -= b, a
        },
        draw: function() {
            ...
            if (d && (b *= 2, c *= 2, e = this.spritePos.x + 2 * w.phases[this.currentPhase], g *= 2, h = a.spriteDefinition.HDPI.STAR.x), this.canvasCtx.save(), this.canvasCtx.globalAlpha = this.opacity, this.drawStars)
                for (var i = 0; i < w.config.NUM_STARS; i++) this.canvasCtx.drawImage(a.imageSprite, h, this.stars[i].sourceY, g, g, Math.round(this.stars[i].x), this.stars[i].y, w.config.STAR_SIZE, w.config.STAR_SIZE);
            this.canvasCtx.drawImage(a.imageSprite, e, this.spritePos.y, b, c, Math.round(this.xPos), this.yPos, f, w.config.HEIGHT), this.canvasCtx.globalAlpha = 1, this.canvasCtx.restore()
        },
        placeStars: function() {
            for (var b = Math.round(this.containerWidth / w.config.NUM_STARS), c = 0; c < w.config.NUM_STARS; c++) this.stars[c] = {}, this.stars[c].x = h(b * c, b * (c + 1)), this.stars[c].y = h(0, w.config.STAR_MAX_Y), d ? this.stars[c].sourceY = a.spriteDefinition.HDPI.STAR.y + 2 * w.config.STAR_SIZE * c : this.stars[c].sourceY = a.spriteDefinition.LDPI.STAR.y + w.config.STAR_SIZE * c
        },
        reset: function() {
        ...
        setSourceDimensions: function() {
            for (var a in x.dimensions) d ? "YPOS" != a && (this.sourceDimensions[a] = 2 * x.dimensions[a]) : this.sourceDimensions[a] = x.dimensions[a], this.dimensions[a] = x.dimensions[a];
            this.xPos = [0, x.dimensions.WIDTH], this.yPos = x.dimensions.YPOS
        },
        getRandomType: function() {
            return Math.random() > this.bumpThreshold ? this.dimensions.WIDTH : 0
        },
        draw: function() {
            this.canvasCtx.drawImage(a.imageSprite, this.sourceXPos[0], this.spritePos.y, this.sourceDimensions.WIDTH, this.sourceDimensions.HEIGHT, this.xPos[0], this.yPos, this.dimensions.WIDTH, this.dimensions.HEIGHT), this.canvasCtx.drawImage(a.imageSprite, this.sourceXPos[1], this.spritePos.y, this.sourceDimensions.WIDTH, this.sourceDimensions.HEIGHT, this.xPos[1], this.yPos, this.dimensions.WIDTH, this.dimensions.HEIGHT)
        },
        updateXPos: function(a, b) {
            var c = a,
                d = 0 == a ? 1 : 0;
            this.xPos[c] -= b, this.xPos[d] = this.xPos[c] + this.dimensions.WIDTH, this.xPos[c] <= -this.dimensions.WIDTH && (this.xPos[c] += 2 * this.dimensions.WIDTH, this.xPos[d] = this.xPos[c] - this.dimensions.WIDTH, this.sourceXPos[c] = this.getRandomType() + this.spritePos.x)
        },
        update: function(a, b) {
            var d = Math.floor(.06 * b * a);
            this.xPos[0] <= 0 ? this.updateXPos(0, d) : this.updateXPos(1, d), this.draw()
        },
        reset: function() {
            this.xPos[0] = 0, this.xPos[1] = x.dimensions.WIDTH
        }
    }, y.config = {
        BG_CLOUD_SPEED: .2,
        BUMPY_THRESHOLD: .3,
        ...
        init: function() {
            this.addCloud(), this.horizonLine = new x(this.canvas, this.spritePos.HORIZON),
                this.nightMode = new w(this.canvas, this.spritePos.MOON, this.dimensions.WIDTH)
        },
        update: function(a, b, c, d) {
            this.runningTime += a, this.horizonLine.update(a, b), this.nightMode.update(d), this.updateClouds(a, b), c && this.updateObstacles(a, b)
        },
        updateClouds: function(a, b) {
            ...
            if (d) {
                ...
                d < this.config.MAX_CLOUDS && this.dimensions.WIDTH - f.xPos > f.cloudGap && this.cloudFrequency > Math.random() && this.addCloud(), this.clouds = this.clouds.filter(function(a) {
                    return !a.remove
                })
            } else this.addCloud()
        },
        ...
        addNewObstacle: function(b) {
            ...
            if (this.duplicateObstacleCheck(d.type) || b < d.minSpeed) this.addNewObstacle(b);
                ...
                this.obstacles.push(new s(this.canvasCtx, d, e, this.dimensions, this.gapCoefficient, b, d.width)), this.obstacleHistory.unshift(d.type), this.obstacleHistory.length > 1 && this.obstacleHistory.splice(a.config.MAX_OBSTACLE_DUPLICATION)
            }
        },
        duplicateObstacleCheck: function(b) {
            for (var c = 0, d = 0; d < this.obstacleHistory.length; d++) c = this.obstacleHistory[d] == b ? c + 1 : 0;
